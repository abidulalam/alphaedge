...
export const GLOSSARY: Record<string, { full: string; desc: string }> = {
  ...
  'Beta':      { full: 'Beta (Market Sensitivity)', desc: 'Measures a stock\'s volatility relative to the overall market. Beta > 1 = more volatile than the market; < 1 = less volatile; negative = moves inversely.' },
  'Div Yield': { full: 'Dividend Yield', desc: 'Annual dividend payment as a percentage of the current share price. Higher yield = more income, but very high yields can signal distress.' },
  '52W High':  { full: '52-Week High', desc: 'The highest price the stock has traded at over the past 52 weeks. Price near the 52W high can indicate strength or resistance.' },
  '52W Low':   { full: '52-Week Low', desc: 'The lowest price the stock has traded at over the past 52 weeks. Price near the 52W low can indicate weakness or a potential support level.' },
